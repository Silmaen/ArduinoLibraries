...
namespace math {
    ...
    public:
        ...
        virtual Matrix3x3 &operator=(const Matrix3x3 &o) = default;
        virtual Matrix3x3 &operator=(Matrix3x3 &&o) noexcept = default;
        ...
        void setByColumn(const vec3f& col1, const vec3f& col2, const vec3f& col3){
            data[0]=col1.x();data[1]=col2.x();data[2]=col3.x();
            data[3]=col1.y();data[4]=col2.y();data[5]=col3.y();
            data[6]=col1.z();data[7]=col2.z();data[8]=col3.z();
        }
        ...
        void setByLine(const vec3f& lin1, const vec3f& lin2, const vec3f& lin3){
            data[0]=lin1.x();data[1]=lin1.y();data[2]=lin1.z();
            data[3]=lin2.x();data[4]=lin2.y();data[5]=lin2.z();
            data[6]=lin3.x();data[7]=lin3.y();data[8]=lin3.z();
        }
