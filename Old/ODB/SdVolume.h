...
public:
	...
	SdVolume() : m_fatType(0),m_allocSearchStart(0),m_blocksPerCluster(0),m_clusterCount(0),m_clusterSizeShift(0),
		m_dataStartBlock(0),m_fatStartBlock(0),m_rootDirEntryCount(0),m_rootDirStart(0) {}
