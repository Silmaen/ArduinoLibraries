...
public:
	...
	Sd2Card() : m_errorCode(SD_CARD_ERROR_INIT_NOT_CALLED), m_type(0),m_status(0),m_sckDivisor(1),m_chipSelectPin(0) {}
	...
	bool readCID(cid_t* cid) {
		return readRegister((uint8_t)CMD10, cid);
	}
	/**
	 ...
	 * \return true for success or false for failure.
	 */
	bool readCSD(union csd_t* csd) {
		return readRegister((uint8_t)CMD9, csd);
	}
